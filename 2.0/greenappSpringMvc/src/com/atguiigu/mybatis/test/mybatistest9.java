...
public class mybatistest9 {
	...
	//ÔÂ²éÑ¯
	  public void selectByTimeWeek(String qishi,String jiesu,String chejian) throws IOException {
	        ...
	        try {
	        	List<employee1> employee=opensession.selectList("com.atguiidu.mybatis.test.employeemapper.selectByTimeWeek",st);	        		        	
