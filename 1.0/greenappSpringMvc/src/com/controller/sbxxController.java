...
public class sbxxController {
	...
	try {
    	List<sbxxbean> sbxxbean=opensession.selectList("com.atguiidu.mybatis.test.employeemapper.sdxx",user.getCj());
    	...
    	for(int i=0;i<sbxxbean.size();i++){
    		pojo.sbxxbean mac= sbxxbean.get(i);
				/*
				 * private String jiqibianhao; private String jiqixinghao; private String
				 * fuzheren; private String chaigoushijian; private String chuchangshijian;
				 */
