...
import com.example.domain.greenapp.network.MainData;
...
public class ShouyeFragment extends Fragment implements ObservableScrollViewCallbacks {
    ...
    private Button hk;
    private  String ruan1,ruan2,ruan3;//pm,温度,湿度
...
//        hj=new ArrayList<String >();
                ...
                if (!wd.equals("exit")) {
                    ...
                    Double x_w1 = Double.parseDouble(min_wd);
                        if (w1 > m_w1) {
                            ...
                            imgwen.setImageResource(R.mipmap.guzhang);
                        }
                }else {
                    hj .add("温度");
                }
            ...
            if (sd.length()>0) {
                if (!sd.equals("exit")) {
                    ...
                    if (s1 > m_s1) {
                        ...
                        imgsd.setImageResource(R.mipmap.guzhang);
                    }
                }else {
                    hj.add("湿度");
                }
            ...
            if (pm.length()>0) {
                if (!pm.equals("exit")) {
                    ...
                    if (p1 > m_p1) {
                        ...
                        imgpm.setImageResource(R.mipmap.guzhang);
                    }
                }else {
                    hj.add("pm2.5");
                }
        ...
        if (pm!=null&&!pm.equals("exit")) {
            if (wd!=null&&!wd.equals("exit")) {
                if (sd!=null&&!sd.equals("exit")) {
                    Log.i("hj--------exit", pm);
                    if (hj.size() > 0) {
