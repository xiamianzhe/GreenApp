...
public class WenduchartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_wenduchart, container, false);
        chartView=view.findViewById(R.id.wendu_chart);
        doPost();
        return view;
    }
    ...
    private void getAxisPoints(){
        if (maxwendu!=null) {
            for (int i = 0; i < maxwendu.length; i++) {
                if (maxwendu[i] != null) {
                    mPointValues.add(new PointValue(i, Math.round(maxwendu[i])).setLabel(maxwendu[i] + "℃"));
                }
            }
        }
    }
    private void getAxisPoints1(){
        if (minwendu!=null) {
            for (int i = 0; i < minwendu.length; i++) {
                if (minwendu[i] != null) {
                    mPointValues1.add(new PointValue(i, Math.round(minwendu[i])).setLabel(minwendu[i] + "℃"));
                }
            }
        }
    }
    ...
    public void doPost() {
//        Log.e("shijian",""+dateFormat.format(date));
        URL url=new URL();
        URL=url.URL;
...
//                Log.e("isJieguo()",""+response.body().isJieguo());
                if (response.body().isJieguo().equals(true)){
                    ...
                    sj.error=response.body().isError();
                    sj.cw=response.body().getCw();
                    sj.dr=response.body().isDr();
                    Log.e("aaaaaaaaaaaaaaaaaaaaaaa",""+map);
                    if (map.get("max_1")!=null){
                        m1=Double.parseDouble(map.get("max_1"));
                    }
                    if (map.get("max_2")!=null){
                        m2=Double.parseDouble(map.get("max_2"));
                    }
                    if (map.get("max_3")!=null){
                        m3=Double.parseDouble(map.get("max_3"));
                    }
                    if (map.get("max_4")!=null){
                        m4=Double.parseDouble(map.get("max_4"));
                    }
                    if (map.get("max_5")!=null){
                        m5=Double.parseDouble(map.get("max_5"));
                    }
                    if (map.get("max_6")!=null){
                        m6=Double.parseDouble(map.get("max_6"));
                    }
                    if (map.get("max_7")!=null){
                        m7=Double.parseDouble(map.get("max_7"));
                    }
                    maxwendu[0]=m7;
                    maxwendu[1]=m6;
                    maxwendu[2]=m5;
                    ...
                    if (map.get("min_1")!=null){
                        x1=Double.parseDouble(map.get("min_1"));
                    }
                    if (map.get("min_2")!=null){
                        x2=Double.parseDouble(map.get("min_2"));
                    }
                    if (map.get("min_3")!=null){
                        x3=Double.parseDouble(map.get("min_3"));
                    }
                    if (map.get("min_4")!=null){
                        x4=Double.parseDouble(map.get("min_4"));
                    }
                    if (map.get("min_5")!=null){
                        x5=Double.parseDouble(map.get("min_5"));
                    }
                    if (map.get("min_6")!=null){
                        x6=Double.parseDouble(map.get("min_6"));
                    }
                    if (map.get("min_7")!=null){
                        x7=Double.parseDouble(map.get("min_7"));
                    }
                    minwendu[0]=x7;
                    minwendu[1]=x6;
                    minwendu[2]=x5;
                    ...
                    maxwendu=null;
                    maxwendu=new Double[7];
                    minwendu=null;
                    minwendu=new Double[7];
                    date=null;
                    date=new String[7];
                    getAxisXLables();
                    getAxisPoints();
